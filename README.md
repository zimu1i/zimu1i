...
I enjoy building **data analytics pipelines**, **dashboards**, and **automated tools** that transform large datasets into *clear*, *actionable* insights. My work focuses on data visualization, metric design, and analytics-driven decision support, with applications in **finance**, **risk/asset management**, and **business intelligence**.
