...
I build **data analytics pipelines**, **dashboards**, and **automated reports** that transform large datasets into *clear*, *actionable* insights. My work focuses on data visualization, metric design, and analytics-driven decision support, with applications in **finance**, **asset management**, and **business intelligence**.
